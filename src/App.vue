    ...
    <div class="cart-container">
      <div class="cart-list">
        <div
          ...
          v-for="item of shoppingCartItems"
          :key="item.id"
        >
          <img
            :src="item.image"
            ...
            <div class="item-actions">
              <div class="quantity-selector">
                ...
                <input
                  ...
                  aria-label="quantity"
                />
                <button class="quantity-change-button" @click="addOne(item.id)">
                  +
                </button>
              </div>
              <button class="remove-item" @click="handleRemove(item.id)">
                ✕
              </button>
            </div>
          </div>
...
function handleRemove(id) {
  let index = shoppingCartItems.value.findIndex((index) => index.id === id);
